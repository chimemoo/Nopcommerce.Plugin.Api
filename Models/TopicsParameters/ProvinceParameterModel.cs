...
{
    [ModelBinder(typeof(ParametersModelBinder<ProvinceParameterModel>))]
    public class ProvinceParameterModel : BaseTopicsParametersModel
    {
        public ProvinceParameterModel()
        {
            Ids = null;
